...
from utils import enable_gpu_growth, WarmUpCallback
...
if __name__ == "__main__":
    logdir_ = 'F:\\PhD\\streaming Shapley value\\参考程序\\ace-main\\ace-main\\logging_save\\bsds'
    config_ = 'F:\\PhD\\streaming Shapley value\\参考程序\\ace-main\\ace-main\\config\\bsds.gin'
    train(logdir_)
    # _main(config_, logdir_, "True", "True", "True")
